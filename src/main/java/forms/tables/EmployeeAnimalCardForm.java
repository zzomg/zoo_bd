...
import entities.EmployeeAnimalCard;
import entities.Entity;
import forms.filters.EmployeeAnimalCardFilterForm;
...
public class EmployeeAnimalCardForm extends JPanel implements NewEntityPanel {
    ...
    private EmployeeAnimalCardFilterForm filterForm;

    public EmployeeAnimalCardForm() {
        $$$setupUI$$$();
    ...
    private void $$$setupUI$$$() {
        ...
        animalLabel.setText("Карта животного");
        mainPanel.add(animalLabel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        empLabel = new JLabel();
    ...
    public void initFilterForm(TableViewForm tableView) {
        filterForm = new EmployeeAnimalCardFilterForm(tableView);
    }
