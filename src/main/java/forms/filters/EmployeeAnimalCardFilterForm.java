...
public class EmployeeAnimalCardFilterForm extends JFrame {
    ...
    public EmployeeAnimalCardFilterForm(TableViewForm tableView) {
        this.tableView = tableView;
        $$$setupUI$$$();
        this.setTitle("Фильтрация ответственных за особь");
    ...
    private void acceptFilter() {
        ...
        if (!"Все".equalsIgnoreCase(Objects.requireNonNull(animalBox.getSelectedItem()).toString())) {
            whereClause += " and card_id = " + splittedCard[0];
        }
    ...
    private void $$$setupUI$$$() {
        ...
        cardLabel.setText("Карта животного");
